...
const features = [
  {
    ...
    description: 'Envie logs de eventos e mapeie operações brutas em atividades limpas prontas para análise.',
  },
  {
    title: 'Detecção de deriva',
    description: 'Identifique desvios comportamentais em traços de execução antes da falha do equipamento.',
  },
  {
    title: 'Decisões de manutenção',
    description: 'Transforme alertas em ações preventivas agendadas e acompanhe os resultados da manutenção.',
  },
]
      ...
      <header className="home-header">
        ...
        <nav className="home-header__nav">
          {!loading && isAuthenticated ? (
            <Link to="/dashboard" className="button button--primary">Ir ao painel</Link>
          ) : (
            <>
              <Link to="/login" className="button button--ghost">Entrar</Link>
              <Link to="/register" className="button button--primary">Criar conta</Link>
            </>
          )}
        </nav>
      </header>
      ...
      <main>
        <section className="home-hero">
          <div className="home-hero__content">
            ...
            <div className="home-hero__actions">
              <Link to="/register" className="button button--primary">Começar</Link>
              <Link to="/login" className="button button--secondary">Entrar</Link>
            </div>
          </div>
        ...
        <section className="home-cta card">
          <div>
            ...
            <p className="muted">
              Crie uma conta de gestor, cadastre seu fluxo de trabalho e prepare-se para enviar logs de eventos.
            </p>
          </div>
          <Link to="/register" className="button button--primary">Criar conta gratuita</Link>
        </section>
      </main>
